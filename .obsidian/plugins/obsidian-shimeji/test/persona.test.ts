...
describe("resolvePersona", () => {
	...
	it("degrades gracefully with no active pack at all", () => {
		expect(() => resolvePersona(undefined, {})).not.toThrow();
		expect(resolvePersona(undefined, {}).length).toBeGreaterThan(0);
	});
});
